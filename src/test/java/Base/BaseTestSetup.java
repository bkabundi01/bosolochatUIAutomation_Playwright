...
public class BaseTestSetup {
    ...
    //this object will be used to access the various action classes and their methods
    protected ActionClasses_Initialization allActionClasses;
//*****************************************************************************************************************************************************
...
//*****************************************************************************************************************************************************
    ...
    //this parameter will grab the parameter from the testng.xml file; parameter preference will be given to that over the config.properties file
    @Parameters({"browser"})
    ...
    public Page pageSetUpFactory(@Optional String browser) throws IOException {
        ...
        if (browser != null) { //if it's not null, it means it's the browser coming from the testng.xml browser parameter
        ...
        allActionClasses = new ActionClasses_Initialization(getPage());
